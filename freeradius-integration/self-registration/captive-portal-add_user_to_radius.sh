...
SUBJECT="new user: $NAME $DHCPHOSTNAME"
BODY="$OWNER
$MAC
$NAME
$EMAIL
...
$MAC_VENDOR
$PRIMARY_DEVICE
$PF_SERVER/mars/userinfo/edit.php?username=$MAC

(mail generated by script marsPortalSense:///home/marsPortal/freeradius-integration/self-registration/captive-portal-add_user_to_radius.sh)"
