	...
	<?php
		...
		switch ($exitCode) {
			...
			case 5:
				...
				echo "<p><b>Your device has reached the maximum daily data bundle during working hours (Monday to Friday from 07:30-12:30 and 13:30-17:00). Please try again tomorrow.</b></p>";
