...
function top_upordown_gerry_mtl($startday, $endday, $topX, $upordown) {
$a = "
	SELECT 
		daily_accounting_v5.username, 
		radusergroup.groupname as groupname, 
		...
		userinfo.hostname, 
		userinfo.mac_vendor, 
		ROUND(SUM(0729_input+0759_input+0829_input+0859_input+0929_input+0959_input+1029_input+1059_input+1129_input+1159_input+1229_input+1259_input+1329_input+1359_input+1429_input+1459_input+1529_input+1559_input+1629_input+1659_input+1729_input+1759_input) / 1000000) as Upload,
		ROUND(SUM(0729_output+0759_output+0829_output+0859_output+0929_output+0959_output+1029_output+1059_output+1129_output+1159_output+1229_output+1259_output+1329_output+1359_output+1429_output+1459_output+1529_output+1559_output+1629_output+1659_output+1729_output+1759_output) / 1000000) as Download 
	FROM daily_accounting_v5
		LEFT JOIN radusergroup ON daily_accounting_v5.username=radusergroup.username 
		LEFT JOIN userinfo ON daily_accounting_v5.username=userinfo.username 
	WHERE daily_accounting_v5.day >= \"" . $startday . "\" AND daily_accounting_v5.day <= \"" . $endday . "\" 
...
function total_upordown_gerry_mtl($startday, $endday, $upordown) {
  return "SELECT 
	ROUND(SUM(0729_input+0759_input+0829_input+0859_input+0929_input+0959_input+1029_input+1059_input+1129_input+1159_input+1229_input+1259_input+1329_input+1359_input+1429_input+1459_input+1529_input+1559_input+1629_input+1659_input+1729_input+1759_input) / 1000000) as Upload,
	ROUND(SUM(0729_output+0759_output+0829_output+0859_output+0929_output+0959_output+1029_output+1059_output+1129_output+1159_output+1229_output+1259_output+1329_output+1359_output+1429_output+1459_output+1529_output+1559_output+1629_output+1659_output+1729_output+1759_output) / 1000000) as Download
   FROM daily_accounting_v5 WHERE day >= \"" . $startday . "\" AND day <= \"" . $endday . "\";";  
...
function generatedailytraffic_gerry_mtl($upordown, $today, $yesterday, $daysago7, $daysago30) {
	...
	$upordown_today_gerry_mtl = query(top_upordown_gerry_mtl($today, $today, 10, $upordown));
	$upordown_yesterday_gerry_mtl = query(top_upordown_gerry_mtl($yesterday, $yesterday, 10, $upordown));
	$upordown_last7days_gerry_mtl = query(top_upordown_gerry_mtl($daysago7, $today, 10, $upordown));
	$upordown_last30days_gerry_mtl = query(top_upordown_gerry_mtl($daysago30, $today, 10, $upordown));

	$upordown_total_today_gerry_mtl = query(total_upordown_gerry_mtl($today, $today, $upordown));
	$upordown_total_yesterday_gerry_mtl = query(total_upordown_gerry_mtl($yesterday, $yesterday, $upordown));
	$upordown_total_last7days_gerry_mtl = query(total_upordown_gerry_mtl($daysago7, $today, $upordown));
	$upordown_total_last30days_gerry_mtl = query(total_upordown_gerry_mtl($daysago30, $today, $upordown));
?>
