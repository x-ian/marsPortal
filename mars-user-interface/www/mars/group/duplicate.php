...
mysqli_query("DELETE FROM groupinfo WHERE groupname='{$_POST['groupname']}'") or die(mysqli_error());
if (isset($_POST['auto_login'])) { 
	mysqli_query("INSERT groupinfo (groupname, auto_login) VALUES ('{$_POST['groupname']}', TRUE)") or die(mysqli_error());
}
