...
<td>
	...
	<a class="btn btn-default btn-xs" href=../device_with_volume.php?username=<?=$row['username']?>>Traffic&nbsp;History</a>&nbsp;<a class="btn btn-default btn-xs" href=>Activity&nbsp;History</a>&nbsp;
