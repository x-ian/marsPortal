...
echo "<td><a href=edit.php?username={$row['username']}>Edit</a><br/><a href=../user_with_volume.php?username={$row['username']}>Transfer&nbsp;History</a><br/><a href=delete.php?username={$row['username']}>Delete</a></td> "; 
echo "</tr>"; 
} 
echo "</table>"; 
