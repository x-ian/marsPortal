...
echo "<td><a href=edit.php?id={$row['id']}>Edit</a> <a href=../user_with_volume.php?username={$row['username']}>Transfer&nbrsp;History</a> <a href=delete.php?id={$row['id']}>Delete</a></td> "; 
echo "</tr>"; 
} 
echo "</table>"; 
